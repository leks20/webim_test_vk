# Webim-test-vk
Тестовое задание: при открытии веб-приложения по кнопке "Авторизироваться" происходит авторизация через "ВКонтакте" и на главной странице показываются имя пользователя и его 5 рандомных друзей
[Yatube](https://webim-test-vk.tk) - пример работы сайта
